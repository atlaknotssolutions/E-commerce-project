    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(addVariant.rejected, (state, action) => {
                state.loading = false;
                state.error = action.payload as string || 'Failed to add variant';
            })
            ...
            .addCase(updateVariant.rejected, (state, action) => {
                state.loading = false;
                state.error = action.payload as string || 'Failed to update variant';
            })
            ...
            .addCase(removeVariant.rejected, (state, action) => {
                state.loading = false;
                state.error = action.payload as string || 'Failed to remove variant';
            })
            ...
            .addCase(updateVariantStock.rejected, (state, action) => {
                state.loading = false;
                state.error = action.payload as string || 'Failed to update variant stock';
            });
    },
});
