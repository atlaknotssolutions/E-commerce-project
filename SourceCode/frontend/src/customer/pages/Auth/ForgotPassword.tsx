...
import { resetPasswordRequest, clearAuthError } from '../../../Redux Toolkit/Customer/AuthSlice';
            ...
            <div className='max-w-md w-full rounded-md border shadow-lg p-10'>
                ...
                {submitted ? (
                    <div className="space-y-5">
                        ...
                        <Link to="/login" className="block text-center text-teal-600 hover:text-teal-800 font-semibold text-sm">
                            Back to Login
                        </Link>
                    </div>
                ) : (
                    <>
                        ...
                        <div className='flex items-center justify-center mt-5'>
                            <Link to="/login" className="text-teal-600 hover:text-teal-800 font-semibold text-sm">
                                Back to Login
                            </Link>
                        </div>
                    </>
