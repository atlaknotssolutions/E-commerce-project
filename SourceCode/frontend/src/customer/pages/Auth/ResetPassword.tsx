...
import { resetPassword, clearAuthError } from '../../../Redux Toolkit/Customer/AuthSlice';
        ...
        return (
            <div className='flex justify-center h-[90vh] items-center'>
                <div className='max-w-md w-full rounded-md border shadow-lg p-10 text-center space-y-4'>
                    ...
                    <Link to="/forgot-password" className="block text-teal-600 hover:text-teal-800 font-semibold text-sm">
