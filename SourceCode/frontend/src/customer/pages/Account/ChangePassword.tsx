...
import { setPassword, clearAuthError } from '../../../Redux Toolkit/Customer/AuthSlice';
...
const ChangePassword = () =>
{
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values: any) =>
        {
            ...
            notification.error(payload?.message || auth.error || 'Failed to update password.');
    ...
    return (
        <div className="max-w-lg">
            <h1 className='text-xl font-bold pb-3'>Password &amp; Security</h1>
