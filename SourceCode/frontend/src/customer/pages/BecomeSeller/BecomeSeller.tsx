  ...
  return (
    <div className="grid md:gap-10 grid-cols-3 min-h-screen ">
      ...
      <section className="hidden md:col-span-1 md:flex lg:col-span-2 justify-center items-center">
        <div className="lg:w-[80%] px-5 space-y-10">

          {/* <div className="borderr rounded-md space-y-2 font-bold text-center">
            <p className="text-2xl">
              Join the {branding.appShortName} Revolution
            </p>
          ...
          {/* <div>
                <p className="logo absolute p-6 rounded-t-full text-white text-center top-0 left-16 right-11 bg-teal-500">
                  {branding.appName}
                </p>
          </div> */}
...
//           {/* <div>
//                 <p className=" logo absolute p-6 rounded-t-full text-white text-center top-0 left-16 right-11 bg-teal-500">{branding.appName}</p>
//             </div> */}
