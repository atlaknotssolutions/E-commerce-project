...
const AddressForm: React.FC<AddressFormProp> = ({ handleClose, paymentGateway, editingAddress, }) =>
{
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) =>
    {
      ...
      await handleSaveAddress(values as Address);
  ...
  const handleSaveAddress = async (address: Address) =>
  {
    ...
    if (
      updateUserAddress.fulfilled.match(result) ||
      addUserAddress.fulfilled.match(result)
    )
    {
      handleClose();
    }
