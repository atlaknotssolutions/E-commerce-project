...
const Home = () => {
    ...
    const categoryTree = homePage.categoryTree;
           ...
           {homePage.homePageData?.shopByCategories && <section className='flex flex-col justify-center items-center py-20 px-5 lg:px-20'>
            ...
            <section className='lg:px-20 relative h-[200px] lg:h-[450px] object-cover'>
                ...
                <div className='absolute top-1/2 left-4 lg:left-[15rem] transform  -translate-y-1/2 font-semibold lg:text-4xl space-y-3 '>
                    ...
                    <p className='text-lg md:text-2xl'>With <strong className='logo text-3xl md:text-5xl pl-2'>{branding.appShortName}</strong></p>
