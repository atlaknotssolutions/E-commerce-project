                ...
                <Box className="space-y-4">
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} sm={6}>
                            ...
                            <Typography>{commission.seller?.companyName || commission.seller?.email || 'N/A'}</Typography>
                        </Grid>
                        <Grid item xs={12} sm={6}>
                        ...
                        <Grid item xs={12} sm={6} md={3}>
                            <Box sx={{ textAlign: 'center', p: 2, border: '1px solid #e0e0e0', borderRadius: 1 }}>
                                <Typography variant="h5" fontWeight={700} color="warning.main">
                                    ₹{commission.gstAmount.toLocaleString()}
                                </Typography>
                                <Typography variant="caption" color="text.secondary">
                                    GST ({commission.gstPercentage}%)
                                </Typography>
                            </Box>
                        </Grid>
                        <Grid item xs={12} sm={6} md={3}>
                            <Box sx={{ textAlign: 'center', p: 2, border: '1px solid #e0e0e0', borderRadius: 1 }}>
                                ...
                                <Typography variant="caption" color="text.secondary">Seller Amount</Typography>
                            </Box>
                        </Grid>
                    </Grid>
                    ...
                    <Box>
                        ...
                        <Typography variant="body2">
                            Commission = ₹{commission.orderAmount.toLocaleString()} × {commission.commissionPercentage}% = ₹{commission.commissionAmount.toLocaleString()}
                        </Typography>
                        <Typography variant="body2">
                            GST = ₹{commission.commissionAmount.toLocaleString()} × {commission.gstPercentage}% = ₹{commission.gstAmount.toLocaleString()}
                        </Typography>
                        <Typography variant="body2" fontWeight={600}>
                            Net Seller = ₹{commission.orderAmount.toLocaleString()} − ₹{commission.commissionAmount.toLocaleString()} − ₹{commission.gstAmount.toLocaleString()} = ₹{commission.sellerAmount.toLocaleString()}
                        </Typography>
                    </Box>
                </Box>
            </DialogContent>
